...
/**
 * Review List Paginate View Model
 *
 ...
 * @author Ryan Wong
 */
class Review_admin_list_paginate_view_model
{
    protected $_library;
    protected $_base_url = '';
    protected $_heading = 'Review';
    protected $_total_rows = 0;
    protected $_format_layout = '';
    protected $_per_page = 10;
    protected $_page;
    protected $_num_links = 5;
    protected $_column = ['Action', 'Id', 'Order Id', 'User', 'Comment', 'Rating', 'Status', 'Private Review'];
    protected $_field_column = ['', 'id', 'order_id', 'user_id', 'comment', 'rating', 'status', 'private_review'];
    protected $_list = [];
    protected $_links = '';
    ...
    {
        return $this->_entity->rating_mapping();
    }
    ...
    {
        return $this->_private_review;
    }

    public function set_private_review($private_review)
    {
        $this->_private_review = $private_review;
    }
    ...
    public function to_json()
    {
        ...
        foreach ($list as $key => $value) {
            $list[$key]->rating = $this->rating_mapping()[$value->rating];
            $clean_list_entry = [];
