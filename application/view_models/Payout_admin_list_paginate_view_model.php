...
/**
 * Payout List Paginate View Model
 *
 ...
 * @author Ryan Wong
 */
class Payout_admin_list_paginate_view_model
{
    protected $_library;
    protected $_base_url = '';
    protected $_heading = 'Payout';
    ...
    public function to_csv()
    {
        ...
        foreach ($clean_list as $row) {
            ...
            foreach ($row as $key => $column) {
                if (in_array($key, $fields) || in_array($key, ['paypal_email'])) {
                    $row_csv[] = '"' . $column . '"';
                }
            }
