          ...
          <form autocomplete="off" class=" " method="post" action="v1/api/add_inventory" enctype="multipart/form-data">
            ...
            <div class="row">
              ...
              <div class="col-12 col-sm-12">
                <div class="form-group">
                  ...
                  <input type="number" name="word_count" class="form-control" placeholder="Enter word count" id="wordcount">
                </div>
              </div>
              <div class="col-12 col-sm-2"></div>
              ...
              <div class="row">
                ...
                <div class="col-12 col-sm-12">
                  <div class="form-group">
                    ...
                    <input type="email" name="paypal_email" class="form-control" placeholder="Enter paypal email" id="email">
                  </div>
                </div>
                <div class="col-12 col-sm-2"></div>
            ...
            <div class="row" style="margin-top:10px;">
              ...
              <div class="col-12 col-sm-12">
                ...
                <div class="checkbox">
                  <label><input type="checkbox" name="remember2"> I agree to Privacy Policy <a href="/privacy_policy"><u>here</u></a></label>
                </div>
              </div>
              <div class="col-12 col-sm-2"></div>
            </div>
