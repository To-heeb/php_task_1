        ...
        <div class="card" id="review_filter_listing">
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                <div class="form-group">
                  <label for="Private Review">Private Review </label>
                  <input type="text" id='private_review' name='private_review' class='form-control' value="<?php echo $this->_data['view_model']->get_private_review(); ?>">
                </div>
              </div>
              <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                <div class="form-group">
